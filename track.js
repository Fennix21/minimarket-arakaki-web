// Mini-analítica del Minimarket Arakaki. Envía pageview y clics clave a /api/track.
...
(function () {
  ...
  window.arkTrack = send; // para eventos manuales (ej. pedido_enviado)
  send('pageview');
  ...
  document.addEventListener('click', function (e) {
    ...
    if (!ev) {
      ...
      else if (href.indexOf('tel:') === 0) ev = 'llamada_click';
    }
    if (ev) send(ev);
  }, true);
})();
