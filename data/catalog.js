// GENERADO por tools/build-catalog.js — no editar a mano (edita catalog-fuente.json y regenera)
window.ARAKAKI_CATALOG = {
 "categories": {
  "pisco": {
   "slug": "pisco",
   "title": "Piscos",
