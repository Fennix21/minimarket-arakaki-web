...
| `api/push.js` | Web Push: GET ?key (clave pública VAPID, caché 5min) · POST subscribe/unsubscribe (rol `clientes` público, `duenos` con pass) · send/test/count (admin, pass). Tope 5000 suscriptores por rol |
